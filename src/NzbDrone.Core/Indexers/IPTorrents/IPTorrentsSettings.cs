...
namespace NzbDrone.Core.Indexers.IPTorrents
{
    ...
    public class IPTorrentsSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(1, Type = FieldType.Number, Label = "Early Download Limit", Unit = "days", HelpText = "Time before release date MusicTubearr will download from this indexer, empty is no limit", Advanced = true)]
