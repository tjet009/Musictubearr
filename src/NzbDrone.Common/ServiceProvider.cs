...
namespace NzbDrone.Common
{
    ...
    {
        public const string SERVICE_NAME = "MusicTubearr";
        ...
        public virtual void Install(string serviceName)
        {
            ...
            var descOutput = _processProvider.StartAndCapture("sc.exe", $"description {serviceName} \"MusicTubearr Application Server\"");
