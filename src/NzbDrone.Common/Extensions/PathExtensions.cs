...
namespace NzbDrone.Common.Extensions
{
    public static class PathExtensions
    {
        ...
        private const string DB = "musictubearr.db";
        private const string DB_RESTORE = "musictubearr.restore";
        ...
        private static readonly string UPDATE_SANDBOX_FOLDER_NAME = "musictubearr_update" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_PACKAGE_FOLDER_NAME = "MusicTubearr" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_FOLDER_NAME = "musictubearr_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_APPDATA_FOLDER_NAME = "musictubearr_appdata_backup" + Path.DirectorySeparatorChar;
