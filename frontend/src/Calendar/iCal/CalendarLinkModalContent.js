...
function getUrls(state) {
  ...
  let icalUrl = `${window.location.host}${window.MusicTubearr.urlBase}/feed/v1/calendar/MusicTubearr.ics?`;
  ...
  icalUrl += `pastDays=${pastDays}&futureDays=${futureDays}&apikey=${encodeURIComponent(window.MusicTubearr.apiKey)}`;
