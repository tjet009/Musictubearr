    ...
    return (
      <PageContent title={translate('GeneralSettings')}>
        ...
        <ConfirmModal
          ...
          message={
            `MusicTubearr requires a restart to apply changes, do you want to restart now? ${isWindowsService ? 'Depending which user is running the MusicTubearr service you may need to restart MusicTubearr as admin once before the service will start automatically.' : ''}`
          }
